    ...
    class Painel
    {
        ...
        public static function alert($tipo,$mensagem){
            if($tipo == 'sucesso'){
                ...
                echo '<div class="box__alert atencao"><i class="fas fa-exclamation-triangle"></i> '.$mensagem.'</div>';
            }
        }
        ...
        public static function selectColor($id){
            $sql = MySql::conectar()->prepare("SELECT `color_user` FROM `tb_admin.usuarios` WHERE `id` = $id");
            $sql->execute();
            return $sql->fetch()['color_user'];
        }
        

        /*
            Method for select only a register.
        */
        ...
        /*
            Method for select all registers.
        */
